...
@Configuration
@EnableJpaRepositories("com.shopstuffs.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.shopstuffs.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.shopstuffs.domain");
        return basePackages;
    }
